...
public class ConfigureFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        summaryView = v.findViewById(R.id.configSummaryText);
        idptext = v.findViewById(R.id.idp_list);
        scadProgress = v.findViewById(R.id.scadProgress);
        removeButton = v.findViewById(R.id.removeButton);
        removeButton.setOnClickListener(this);
        scadButton = v.findViewById(R.id.scadButton);
                ...
                .setPositiveButton(getString(R.string.button_yes), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (eduroamCAT.profiles.isEmpty()) {
                            ...
                            TextView summaryView = getView().findViewById(R.id.configSummaryText);
