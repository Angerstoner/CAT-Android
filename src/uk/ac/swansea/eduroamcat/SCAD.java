...
public class SCAD extends AsyncTask<String, Integer, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        if (result.length() > 0 && geoip != null)
            try {
                ...
                if (ConfigureFragment.scadProgress != null)
                    ConfigureFragment.scadProgress.setVisibility(View.GONE);
        ...
        if (IdPs.size() < 1) {
            ...
            if (!hasAccuracy)
                locationServiceCheck = "<font color=\"red\">" + activity.getString(R.string.scad_geoip_insufficient) + "</font>";
            if (!network_enabled)
                locationServiceCheck = "<font color=\"red\">" + activity.getString(R.string.scad_geoip_noloc) + "</font>";
