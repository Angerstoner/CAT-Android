...
public class AuthenticationMethod {
    ...
    public void setOuterEAPType(int eaptype) {
        if (eaptype > 0) {
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "outerEAPType=" + eaptype);
    }
    ...
    public void setInnerEAPType(int eaptype) {
        if (eaptype > 0) {
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "innerEAPType=" + eaptype);
    }
    ...
    public void setInnerNonEAPType(int eaptype) {
        if (eaptype > 0) {
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "innerNonEAPType=" + eaptype);
    }
    ...
    public void addServerID(String aServerID) {
        if (aServerID.length() > 0) serverIDs.add(aServerID);
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "Server ID=" + aServerID);
    }
    ...
    public void setAnonID(String anonID, Boolean save) {
        if (anonID.length() > 0) {
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "anonymous ID=" + anonID);
    }
