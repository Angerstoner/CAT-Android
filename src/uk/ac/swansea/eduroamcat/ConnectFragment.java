...
//    	}
            ...
            for (WifiConfiguration currentConfig : currentConfigs) {
                if (currentConfig.SSID != null)
                    if (currentConfig.SSID.equals("\"eduroam\"")) {
                        ...
                        if (summary_template.contains("\"#000001\""))
                            state1_image.setImageResource(R.drawable.cross);
                        else if (summary_template.contains("\"#000000\""))
                            state1_image.setImageResource(R.drawable.question);
                        else if (summary_template.contains("\"black\""))
                        ...
                        if (state2_text.contains("\"#000001\""))
                            state2_image.setImageResource(R.drawable.cross);
                        else if (state2_text.contains("\"#000000\""))
                            state2_image.setImageResource(R.drawable.question);
                        else if (state2_text.contains("\"black\""))
                        ...
                        if (state3_text.contains("\"#000001\""))
                            state3_image.setImageResource(R.drawable.cross);
                        else if (state3_text.contains("\"#000000\""))
                            state3_image.setImageResource(R.drawable.question);
                        else if (state3_text.contains("\"black\""))
                        ...
                        if (state4_text.contains("\"#000001\""))
                            state4_image.setImageResource(R.drawable.cross);
                        else if (state4_text.contains("\"#000000\""))
                            state4_image.setImageResource(R.drawable.question);
                        else if (state4_text.contains("\"black\""))
                        ...
                        if (state6_text.contains("\"#000001\""))
                            state6_image.setImageResource(R.drawable.cross);
                        else if (state6_text.contains("\"#000000\""))
                            state6_image.setImageResource(R.drawable.question);
                        else if (state6_text.contains("\"black\""))
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        authMethodSpinner = v.findViewById(R.id.ssids);
        ssidSpinner = v.findViewById(R.id.ssids2);
        state1 = v.findViewById(R.id.stateText1);
        state1_image = v.findViewById(R.id.imageView1);
        state2 = v.findViewById(R.id.stateText2);
        state2_image = v.findViewById(R.id.imageView2);
        state3 = v.findViewById(R.id.stateText3);
        state3_image = v.findViewById(R.id.imageView3);
        state4 = v.findViewById(R.id.stateText4);
        state4_image = v.findViewById(R.id.imageView4);
        state5 = v.findViewById(R.id.stateText5);
        state5_image = v.findViewById(R.id.imageView5);
        state6 = v.findViewById(R.id.stateText6);
        state6_image = v.findViewById(R.id.imageView6);
        feedback = v.findViewById(R.id.feedback);
        state5_layout = v.findViewById(R.id.state5_layout);
        state2_layout = v.findViewById(R.id.state2_layout);
        state3_layout = v.findViewById(R.id.state3_layout);
        state6_layout = v.findViewById(R.id.state6_layout);
        //ssids.setOnItemClickListener(this);
        warning = v.findViewById(R.id.textView3);
        username = v.findViewById(R.id.username);
        password = v.findViewById(R.id.password);
        passText = v.findViewById(R.id.textView2);
        userText = v.findViewById(R.id.textView1);
        ...
        if (db.getReadableDatabase() != null)
            if (getStoredUsername().length() > 0) username.setText(getStoredUsername());
        db.close();
            ...
            if (eduroamCAT.profiles.size() > 0 && eduroamCAT.wifiProfile.hasError() == false) {
                ...
                if (authMethodNumber > 0) {
                    ...
                    while (authMethodNumber <= eduroamCAT.profiles.get(0).getNumberAuthenticationMethods()) {
                        ...
                        if (usernameValue.length() == 0 && theAuthMethod.getOuterEAPType() == 13)
                            usernameValue = theAuthMethod.getClientPrivateKeySubjectCN();
...
//					  			startActivity(new Intent(Intent.ACTION_VIEW, uri));
                            ...
                            if (authMethodNumber < eduroamCAT.profiles.get(0).getNumberAuthenticationMethods()) {
                                if (eduroamCAT.profiles.get(0).getNumberAuthenticationMethods() > 1)
                                    eduroamCAT.alertUser("AuthMethod #" + authMethodNumber + " failed. trying next...", "Failed", this.getActivity());
                                else
                                    eduroamCAT.alertUser("AuthMethod #" + authMethodNumber + " failed.", getString(R.string.profile_failed), this.getActivity());
                                authMethodNumber++;
                                failures++;
                                continue;
                            } else {
