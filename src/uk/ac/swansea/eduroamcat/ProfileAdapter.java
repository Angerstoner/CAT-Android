...
public class ProfileAdapter extends ArrayAdapter<IdP> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView logo = convertView.findViewById(R.id.icon);
        ...
        if (aIdP.profileID.size() > 1) {
            ...
            LinearLayout layout = convertView.findViewById(R.id.profiles);
            RelativeLayout item = convertView.findViewById(R.id.itemlayout);
