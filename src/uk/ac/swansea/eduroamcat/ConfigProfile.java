...
public class ConfigProfile {
    ...
    public void setEAPIdP_ID(String ID) {
        if (ID.length() > 0) {
            ...
            setConfigError(Resources.getSystem().getString(R.string.error_with) + "EAPIdp_ID length:ID=" + ID);
    }
    ...
    public void setDisplayName(String adisplayName, String aLang) {
        if (adisplayName.length() > 0 && aLang.length() > 0) {
            ...
            if (adisplayName.length() > 0) {
                ...
                setConfigError(Resources.getSystem().getString(R.string.error_with) + "Display Name and Lang=" + displayName);
        }
    }
    ...
    public Boolean removeAuthenticationMethod(int index) {
        ...
        if (authenticationMethods.size() >= index) {
            authenticationMethods.remove(index);
            return true;
        } else return false;
    }
