...
//			}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        statusInfo = v.findViewById(R.id.statusInfo);
        verboseDebug = v.findViewById(R.id.toggleVerbose);
        ...
        quickConnect = v.findViewById(R.id.quickConnect);
        ...
        toggleWifi = v.findViewById(R.id.toggleWifi);
        ...
        //duplicate button
        duplicate = v.findViewById(R.id.duplicateButton);
