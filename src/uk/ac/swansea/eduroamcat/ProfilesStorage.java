    ...
    public ArrayList<ConfigProfile> getEAPProfiles() {
        ...
        if (res.moveToFirst()) {
            while (!res.isAfterLast()) {
                ...
                if (res.getString(7).length() > 0) {
                    tempProfile.setHelpdeskEmail(res.getString(7), "");
                    tempProfile.setHelpdeskInfo(true);
                }
                if (res.getString(8).length() > 0) {
                    tempProfile.setHelpdeskPhone(res.getString(8), "");
                    tempProfile.setHelpdeskInfo(true);
                }
                if (res.getString(9).length() > 0) {
                    tempProfile.setHelpdeskURL(res.getString(9), "");
                    tempProfile.setHelpdeskInfo(true);
                }
                ...
                if (res2.moveToFirst()) {
                    while (!res2.isAfterLast()) {
                        ...
                        try {
                            if (res2.getString(13).length() > 0)
                                tempAuthMethod.setCAcert(res2.getString(13), res2.getString(6), res2.getString(5));
                        ...
                        if (res2.getString(11).length() > 0)
                            tempAuthMethod.setAnonID(res2.getString(11), true);
